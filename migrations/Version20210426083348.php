 ...
 */
final class Version20210426083348 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE video_like CHANGE video_id video_id INT NOT NULL, CHANGE user_id user_id INT NOT NULL');
    }
