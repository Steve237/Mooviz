 ...
 */
final class Version20210310001918 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE likes_videos (likes_id INT NOT NULL, videos_id INT NOT NULL, INDEX IDX_2DCDBE8B2F23775F (likes_id), INDEX IDX_2DCDBE8B763C10B2 (videos_id), PRIMARY KEY(likes_id, videos_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
